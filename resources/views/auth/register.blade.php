...
<div class="w-full max-w-md px-4">
    <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div class="bg-[#1a472a] px-8 py-8 text-center">
            ...
            <p class="text-sm text-[#b7e4c7] mt-1">Criar minha conta</p>
        </div>

        {{-- Form --}}
        <div class="px-8 py-8">
            <h2 class="text-lg font-semibold text-gray-900 mb-2">Cadastro rápido</h2>
            <p class="text-sm text-gray-500 mb-6">Leva menos de um minuto. Depois você escolhe se quer retirar o pedido ou receber em casa.</p>
            ...
            <div class="mt-6 p-4 bg-gray-50 rounded-lg text-center">
                <p class="text-sm text-gray-600">
                    Já tem conta?
                    <a href="{{ route('login') }}" class="font-semibold text-[#1a472a] hover:underline">Entrar</a>
                </p>
            </div>
        </div>
    </div>
