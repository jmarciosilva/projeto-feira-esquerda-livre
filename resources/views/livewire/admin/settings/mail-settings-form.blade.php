                ...
                <x-admin.card title="Servidor de Envio (SMTP)">
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            @if($mail_password_configurada)
                            <div class="mb-2 flex items-center justify-between gap-3 text-xs">
                                <span class="text-green-800"><strong>Senha configurada.</strong></span>
                                <button type="button" wire:click="removerSenha"
                                        wire:confirm="Remover a senha SMTP gravada?"
                            ...
                            <input
                                ...
                                placeholder="{{ $mail_password_configurada ? 'Digite para substituir a senha atual' : 'Senha do servidor SMTP' }}"
                            ...
                            >
                            <p class="mt-1 text-xs text-gray-400">{{ $mail_password_configurada ? 'Deixe em branco para manter a senha atual.' : 'Senha do usuário SMTP, se o servidor exigir.' }}</p>
