<div>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="py-3 px-2">
                            ...
                            <div class="flex items-center justify-end gap-2">
                                ...
                                <button wire:click="confirmDelete({{ $menu->id }})" class="text-gray-400 hover:text-red-600">
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
        <div class="bg-white rounded-xl shadow-xl max-w-md w-full p-6">
            <h3 class="text-lg font-semibold text-gray-900 mb-4">{{ $editId ? 'Editar Menu' : 'Novo Menu' }}</h3>
            <div class="space-y-4">
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
        <div class="bg-white rounded-xl shadow-xl max-w-sm w-full p-6">
            ...
            <p class="text-sm text-gray-600 mb-6">O menu e todos os seus itens serão excluídos.</p>
            <div class="flex gap-3 justify-end">
                <x-admin.button variant="secondary" wire:click="$set('confirmDelete', false)">Cancelar</x-admin.button>
                <x-admin.button variant="danger" wire:click="deleteMenu">Excluir</x-admin.button>
            </div>
        </div>
    </div>
    @endif
