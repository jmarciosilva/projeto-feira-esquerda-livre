<div>
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="py-3 px-2">
                            <div class="flex items-center justify-end gap-2">
                                ...
                                <button wire:click="confirmDelete({{ $page->id }})" class="text-gray-400 hover:text-red-600 transition-colors" title="Excluir">
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
        <div class="bg-white rounded-xl shadow-xl max-w-sm w-full p-6">
            ...
            <p class="text-sm text-gray-600 mb-6">Esta ação não pode ser desfeita. A página e todas as suas seções serão removidas permanentemente.</p>
            <div class="flex gap-3 justify-end">
                <x-admin.button variant="secondary" wire:click="$set('confirmDelete', false)">Cancelar</x-admin.button>
                <x-admin.button variant="danger" wire:click="deletePage">Excluir</x-admin.button>
            </div>
        </div>
    </div>
    @endif
